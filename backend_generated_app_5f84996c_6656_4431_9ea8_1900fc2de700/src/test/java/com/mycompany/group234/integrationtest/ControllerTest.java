...
class ControllerTest {
  ...
  void  teardown() {
    ...
    jdbcTemplate.execute("DELETE FROM generated_app.GitHubCreds");
     ...
     jdbcTemplate.execute("DELETE FROM generated_app.FECapabilityFeatures");
     jdbcTemplate.execute("DELETE FROM generated_app.BETechnologyBeTechnologyFeatures");
     jdbcTemplate.execute("DELETE FROM generated_app.BECapabilityFeatures");
     jdbcTemplate.execute("DELETE FROM generated_app.FrontendAppMetaTags");
     jdbcTemplate.execute("DELETE FROM generated_app.DatabaseFeatures");
     ...
     jdbcTemplate.execute("DELETE FROM generated_app.TemplateScreenFeatures");
     ...
     jdbcTemplate.execute("DELETE FROM generated_app.CapabilityFeatures");
